...
sudo zypper --non-interactive install -y zsh vlc clementine breeze5-cursors vim nmap blender brasero gparted wireshark tmux curl vpnc git htop meld openvpn guake python3-pip gtk2-engines krita audacity filezilla tree remmina nload pwgen sysstat alacarte fzf ffmpeg xclip flameshot unrar zip awk net-tools coreutils ncdu whois piper openssl gnome-keyring chrome-gnome-shell telnet openssh materia-gtk-theme alacritty scrot libstdc++-devel glibc-static net-tools-deprecated xprop wmctrl xdotool gcc-c++ sassc virtualbox golang npm bc sqlite3 python3-pipx ruby ruby-devel ruby nodejs git gcc make libopenssl-devel sqlite3-devel cifs-utils cron kdeconnect-kde solaar android-tools xwininfo xbindkeys rustup libX11-devel libXcursor-devel jgmenu papirus-icon-theme nmon google-noto-sans-cjk-fonts python3-devel sensors xcb-util-cursor-devel xdg-desktop-portal xdg-desktop-portal-gtk
