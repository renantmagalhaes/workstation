...
# NOT wired up: protoarc-battery.py (hidraw query for the ProtoArc EM01 NL / Compx
# 2.4G receiver). Confirmed via ~2 days of logged samples that its report is a static
# cached value, not a live battery reading - see the file's header comment.
