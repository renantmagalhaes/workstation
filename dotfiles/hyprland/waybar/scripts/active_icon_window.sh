...
elif match "crx_coobgpohoikkiipiblmjeljniedjpjpf"; then icon=""   # Chrome Ext Host
...
elif match "crx_cjpalhdlnbpafiamejdnhcphjbkeiagm"; then icon=""   # uBlock
...
# Also catch common webapp titles for Wayland-native instances
elif match "whatsapp web"; then icon=""
elif match "gmail"; then icon=""
elif match "calendar"; then icon=""
...
elif match "chrome" || match "chromium"; then icon=""
elif match "brave"; then icon=""
elif match "edge"; then icon="󰇩"
elif match "tor"; then icon=""
elif match "epiphany" || match "gnome-web" || match "web"; then icon=""
...
# Editors / IDEs
# ───────────────────────────────────────────────
elif match " code" || match "vscode" || match "visual studio code"; then icon="󰨞"
...
# File Managers
# ───────────────────────────────────────────────
elif match "nautilus" || match "org.gnome.nautilus"; then icon=""
elif match "dolphin"; then icon=""
elif match "nemo"; then icon=""
elif match "thunar"; then icon=""
elif match "pcmanfm"; then icon=""
...
# Office / Productivity
# ───────────────────────────────────────────────
elif match "libreoffice" || match "writer" || match "calc" || match "impress"; then icon="󰈬"
elif match "evince" || match "okular" || match "zathura"; then icon=""
elif match "gimp" || match "inkscape" || match "krita"; then icon=""
...
elif match "gnome-disks" || match "gparted"; then icon=""
elif match "htop" || match "btop"; then icon="󰍛"
elif match "virt-manager" || match "virt-viewer"; then icon=""
elif match "virtualbox" || match "vmware" || match "qemu" || match "quickemu"; then icon="󰆧"
...
elif match "lutris" || match "heroic"; then icon="󰖺"
elif match "bottles"; then icon="󰡶"
elif match "obs"; then icon="󰨜"
elif match "filezilla"; then icon="󰏇"
elif match "transmission" || match "deluge" || match "qbittorrent"; then icon=""
elif match "ark"; then icon=""
elif match "baobab"; then icon="󰋊"
elif match "xviewer" || match "eog" || match "gwenview"; then icon="󰈥"
elif match "flameshot" || match "spectacle" || match "grim" || match "swappy"; then icon=""
elif match "gnome-calendar"; then icon=""
elif match "keepassxc" || match "bitwarden"; then icon=""
elif match "burp"; then icon=""
elif match "wireshark" || match "zenmap"; then icon="󰲡"
elif match "postman" || match "insomnia"; then icon="󰘬"
